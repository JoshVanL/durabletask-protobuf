...
var file_runtime_state_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0a, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x12, 0x2b, 0x0a,
	...
	0x65, 0x6e, 0x74, 0x49, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x42, 0x56, 0x0a,
...
var file_runtime_state_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_runtime_state_proto_goTypes = []interface{}{
	...
	(StalledReason)(0),                  // 4: StalledReason
	(*HistoryEvent)(nil),                // 5: HistoryEvent
	...
	(WorkflowStatus)(0),                 // 10: WorkflowStatus
	(*TaskFailureDetails)(nil),          // 11: TaskFailureDetails
}
var file_runtime_state_proto_depIdxs = []int32{
	4,  // 0: durabletask.protos.backend.v1.RuntimeStateStalled.reason:type_name -> StalledReason
	5,  // 1: durabletask.protos.backend.v1.WorkflowRuntimeState.newEvents:type_name -> HistoryEvent
	5,  // 2: durabletask.protos.backend.v1.WorkflowRuntimeState.oldEvents:type_name -> HistoryEvent
	5,  // 3: durabletask.protos.backend.v1.WorkflowRuntimeState.pendingTasks:type_name -> HistoryEvent
	5,  // 4: durabletask.protos.backend.v1.WorkflowRuntimeState.pendingTimers:type_name -> HistoryEvent
	...
	6,  // 6: durabletask.protos.backend.v1.WorkflowRuntimeState.startEvent:type_name -> ExecutionStartedEvent
	7,  // 7: durabletask.protos.backend.v1.WorkflowRuntimeState.completedEvent:type_name -> ExecutionCompletedEvent
	8,  // 8: durabletask.protos.backend.v1.WorkflowRuntimeState.createdTime:type_name -> google.protobuf.Timestamp
	8,  // 9: durabletask.protos.backend.v1.WorkflowRuntimeState.lastUpdatedTime:type_name -> google.protobuf.Timestamp
	8,  // 10: durabletask.protos.backend.v1.WorkflowRuntimeState.completedTime:type_name -> google.protobuf.Timestamp
	9,  // 11: durabletask.protos.backend.v1.WorkflowRuntimeState.customStatus:type_name -> google.protobuf.StringValue
	...
	5,  // 13: durabletask.protos.backend.v1.WorkflowRuntimeStateMessage.historyEvent:type_name -> HistoryEvent
	10, // 14: durabletask.protos.backend.v1.WorkflowMetadata.runtimeStatus:type_name -> WorkflowStatus
	8,  // 15: durabletask.protos.backend.v1.WorkflowMetadata.createdAt:type_name -> google.protobuf.Timestamp
	8,  // 16: durabletask.protos.backend.v1.WorkflowMetadata.lastUpdatedAt:type_name -> google.protobuf.Timestamp
	9,  // 17: durabletask.protos.backend.v1.WorkflowMetadata.input:type_name -> google.protobuf.StringValue
	9,  // 18: durabletask.protos.backend.v1.WorkflowMetadata.output:type_name -> google.protobuf.StringValue
	9,  // 19: durabletask.protos.backend.v1.WorkflowMetadata.customStatus:type_name -> google.protobuf.StringValue
	11, // 20: durabletask.protos.backend.v1.WorkflowMetadata.failureDetails:type_name -> TaskFailureDetails
	8,  // 21: durabletask.protos.backend.v1.WorkflowMetadata.completedAt:type_name -> google.protobuf.Timestamp
